...
public class Serializator {
    public boolean serialization(Aircraft s, String fileName) {
        boolean flag = false;
    ...
    public Aircraft deserialization(String fileName) throws InvalidObjectException {
        ...
        try {
            ...
            // десериализация
            Aircraft st = (Aircraft) istream.readObject();
            return st;
